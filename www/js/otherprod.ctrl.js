...
angular.module('app').controller("otherprodDetailController", function($scope, $http, $filter, ConstantService, $cordovaFile, $localStorage){
    vm = this;
    ...
    vm.init = function($scope){
        ...
        $http.get(ConstantService.wsURL + '/otherprodbyID.json?product_id='+vm.id)
            .success( function(response){              
                    ...
                    vm.isFetching = false;
                    vm.failed = false;
                    $localStorage.setObject('otherprodbyID_'+vm.id,items);
                    vm.isOffline = false;
            ...
            .error(function(error){                    
                    vm.failed = true;                                   
                    vm.isFetching = false;       
                    vm.wines = $localStorage.getObject('otherprodbyID_'+vm.id);
                    vm.isOffline = true;
                    console.log('failed');
                });                
        } else {
            ...
            var tmp = $localStorage.getObject('otherprod');
            ...
            console.log('otherprodDetailController with localStorage');
            vm.isFetching = false;
